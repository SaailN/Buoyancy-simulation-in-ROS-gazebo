...
#ifndef GAZEBO_PLUGINS_BUOYANCYPLUGIN1_HH_
#define GAZEBO_PLUGINS_BUOYANCYPLUGIN1_HH_
...
namespace gazebo
{
  ...
  /// collision shapes.
  class GAZEBO_VISIBLE BuoyancyPlugin1 : public ModelPlugin
  {
    /// \brief Constructor.
    public: BuoyancyPlugin1();
